# CurSlack - Cursor Agent via Slack

Integração do **Cursor AI Cloud Agent** com o **Slack**, conectado ao **GitHub**. Este repositório é operado por um agente de IA autônomo que pode ser invocado diretamente do Slack para realizar tarefas de engenharia de software completas.
...
O **CurSlack** conecta o Cursor AI ao Slack por meio do app oficial do Cursor para Slack e da integração com o GitHub. Isso permite que qualquer membro da equipe solicite tarefas de codificação, revisão, criação de PRs e muito mais — tudo diretamente de uma conversa no Slack, sem precisar abrir o editor.
